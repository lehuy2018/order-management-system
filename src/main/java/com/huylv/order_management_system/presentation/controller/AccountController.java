...
public class AccountController {
    ...
    @GetMapping("/by-email")
    public ResponseEntity<UserInfoResponse> getUserInfoByEmail(@RequestParam @Valid @NotBlank @Email String email) {
        return ResponseEntity.ok(accountService.getUserInfoByEmail(email));
    }
